        ...
        <div className="max-w-7xl mx-auto px-8">
          ...
          >
            ...
            <p className="text-outline text-sm">
              Standard with every Usha Infotech engagement
            </p>
          </motion.div>
          <motion.div
            ...
            {[
              {
                ...
                desc: "All hardware comes with OEM warranty",
              },
              {
                title: "Fast Deployment",
                desc: "Most setups completed within 3-5 days",
              },
              {
                title: "Dedicated Support",
                desc: "Direct line to your assigned engineer",
              },
              {
                title: "Full Documentation",
                desc: "Network maps, credentials, asset lists",
              },
            ].map((item) => (
              <motion.div
                key={item.title}
