...
const stats = [
  ...
  { target: 50, prefix: '₹', suffix: 'Cr+', label: 'Capital Saved', icon: '💰' },
]
    ...
    <section className="relative min-h-screen flex items-center pt-24 pb-16 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8 w-full">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            IT Infrastructure · AMC Support · Refurbished · Rentals · Security Systems · Networking<br />
            <span className="text-slate-400 text-base">No technical knowledge needed — everything handled for you.</span>
          </motion.p>
          ...
          >
            <Link to="/services" className="btn-primary text-base px-7 py-4 shadow-blue">
              Explore Services
              <svg className="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
              </svg>
            </Link>
            <a href="tel:+918087051208" className="btn-secondary text-base px-7 py-4">
