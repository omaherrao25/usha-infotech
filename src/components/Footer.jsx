          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <a
                ...
                aria-label="WhatsApp Usha Infotech"
              >
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            <Link to="/" className="flex items-center gap-3 mb-6" aria-label="Usha Infotech — Home">
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                aria-label="Usha Infotech on Facebook"
              >
                f
              </a>
              <a
                ...
                aria-label="Usha Infotech on Instagram"
              >
                ig
              </a>
            </div>
          ...
          <div>
            ...
            <nav className="flex flex-col gap-3" aria-label="Footer services links">
          ...
          <div>
            ...
            <address className="not-italic flex flex-col gap-4 text-sm text-slate-400">
              <div className="flex items-start gap-3">
                <span className="mt-0.5 text-blue-400 text-base" aria-hidden="true">📍</span>
              ...
              <div className="flex items-center gap-3">
                <span className="text-blue-400 text-base" aria-hidden="true">🕐</span>
              ...
              >
                <span className="text-blue-400 text-base" aria-hidden="true">✉️</span>
      ...
      <div className="border-t border-slate-800">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-slate-500 text-xs tracking-wider uppercase">
            &copy; {new Date().getFullYear()} Usha Infotech. All Rights Reserved.
          </p>
